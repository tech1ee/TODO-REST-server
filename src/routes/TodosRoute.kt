...
fun Route.todos(db: Repository) {
    authenticate("jwt") {
        post<TodoRoute> {
            ...
            val todo = todosParameters["todo"] ?: return@post call.respond(HttpStatusCode.BadRequest, "Missing Todo")
            ...
            try {
                ...
                currentTodo?.id?.let { call.respond(HttpStatusCode.OK, currentTodo) }
            } catch (e: Throwable) {
        ...
        get<TodoRoute> {
            ...
            try {
                ...
                call.respond(HttpStatusCode.BadRequest, "Problems getting Todo")
            }
        }
    }
}